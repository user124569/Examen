...
def main(base_path):
    ...
    try:
        ...
        spark = pyspark.sql.SparkSession(
            sc).builder.appName(APP_NAME).getOrCreate()
...
if __name__ == "__main__":
    ...
    main(base_path)
    # Se escribe un fichero /tmp/chivato que cuadno se crea hace que avance el spark submit. Hasta que no esté entrenado el modelo no arranca.
    chivato = "{}/models/chivato".format(base_path)
    k = open(chivato, 'w')
    k.write('1')
    k.close()